...
public class VE_notInBetweenMulti extends ValidationException
{
	...
	public VE_notInBetweenMulti(int stackreduction, int min, int max, int... values)
	{
		this();
	...
	public VE_notInBetweenMulti(int stackreduction, long min, long max, long... values)
	{
		this();
	...
	public VE_notInBetweenMulti(int stackreduction, float min, float max, float... values)
	{
		this();
	...
	public VE_notInBetweenMulti(int stackreduction, double min, double max, double... values)
	{
		this();
	...
	private VE_notInBetweenMulti() { super("notInBetween(Multi)", "At least one of the values is between limits!"); }

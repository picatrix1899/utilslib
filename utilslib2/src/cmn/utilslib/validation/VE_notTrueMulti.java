...
public class VE_notTrueMulti extends ValidationException
{
	...
	public VE_notTrueMulti(int stackreduction, boolean... values)
	{
		this();
	...
	private VE_notTrueMulti() { super("notTrue(Multi)", "At least one of the values is true!"); }

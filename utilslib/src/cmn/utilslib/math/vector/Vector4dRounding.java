...
public class Vector4dRounding
{

	public static Vector4d floorN(Vector4d v)
	{
		Vector4d out = v.clone();
	...
	public static Vector4d floorN(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
		Vector4d out = v.clone();
	...
	public static Vec4d floorN(Vec4dBase v)
	{
		Vec4d out = v.clone();
	...
	public static Vec4d floorN(Vec4dBase v, boolean x, boolean y, boolean z, boolean a)
	{
		Vec4d out = v.clone();
	...
	public static Vector4d floor(Vector4d v)
	{
	...
	public static Vector4d floor(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
	...
	public static Vector4d ceilN(Vector4d v)
	{
		Vector4d out = v.clone();
	...
	public static Vector4d ceilN(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
		Vector4d out = v.clone();
	...
	public static Vec4d ceilN(Vec4dBase v)
	{
		Vec4d out = v.clone();
	...
	public static Vec4d ceilN(Vec4dBase v, boolean x, boolean y, boolean z, boolean a)
	{
		Vec4d out = v.clone();
	...
	public static Vector4d ceil(Vector4d v)
	{
	...
	public static Vector4d ceil(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
	...
	public static Vec4d ceil(Vec4d v)
	{
	...
	public static Vector4d roundN(Vector4d v)
	{
		Vector4d out = v.clone();
	...
	public static Vector4d roundN(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
		Vector4d out = v.clone();
	...
	public static Vec4d roundN(Vec4dBase v)
	{
		Vec4d out = v.clone();
	...
	public static Vec4d roundN(Vec4dBase v, boolean x, boolean y, boolean z, boolean a)
	{
		Vec4d out = v.clone();
	...
	public static Vector4d round(Vector4d v)
	{
	...
	public static Vector4d round(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
	...
	public static Vec4d round(Vec4d v)
	{
	...
	public static Vector4d absN(Vector4d v)
	{
		Vector4d out = v.clone();
	...
	public static Vector4d absN(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{
		Vector4d out = v.clone();
	...
	public static Vec4d absN(Vec4dBase v)
	{
		Vec4d out = v.clone();
	...
	public static Vec4d absN(Vec4dBase v, boolean x, boolean y, boolean z, boolean a)
	{
		Vec4d out = v.clone();
	...
	public static Vector4d abs(Vector4d v)
	{
	...
	public static Vector4d abs(Vector4d v, boolean x, boolean y, boolean z, boolean a)
	{

...
public class VE_notAboveMulti extends ValidationException
{
	...
	public VE_notAboveMulti(int stackreduction, int min, int... values)
	{
		this();
	...
	public VE_notAboveMulti(int stackreduction, long min, long... values)
	{
		this();
	...
	public VE_notAboveMulti(int stackreduction, float min, float... values)
	{
		this();
	...
	public VE_notAboveMulti(int stackreduction, double min, double... values)
	{
		this();
	...
	private VE_notAboveMulti() { super("notAbove(Multi)", "At least one of the values is above exclusive minimum threshold!"); }

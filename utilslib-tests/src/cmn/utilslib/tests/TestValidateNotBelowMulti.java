...
import cmn.utilslib.validation.VE_notBelowMulti;
import cmn.utilslib.validation.Validate;
import cmn.utilslib.validation.ValidationException;

public class TestValidateNotBelowMulti implements IUnitTest
{
	...
	public boolean testNegativeFloat()
	{
		...
		{
			Validate.notBelow(1.0f, -1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, -1.0f, 2.0f);
		}
	...
	public boolean testNegativeInt()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.notBelow(1, -1, 2, 2, 2, 2, 2, 2, -1, 2);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testNegativeDouble()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.notBelow(1.0d, -1.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, -1.0d, 2.0d);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveFloat()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.notBelow(1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveDouble()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.notBelow(1.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d);
		}
		ValidationException.resetErrorHandler();

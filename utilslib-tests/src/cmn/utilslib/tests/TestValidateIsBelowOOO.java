...
import cmn.utilslib.validation.VE_isBelowOOO;
import cmn.utilslib.validation.Validate;
import cmn.utilslib.validation.ValidationException;

public class TestValidateIsBelowOOO implements IUnitTest
{
	...
	public boolean testNegativeFloat()
	{
		...
		{
			Validate.isBelowOOO(1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f);
		}
		ValidationException.resetErrorHandler();
		
		if(handler.getCount() == 1)
			if(handler.getType(0).equals(VE_isBelowOOO.class))
				return true;
	...
	public boolean testNegativeInt()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1, 2, 2, 2, 2, 2, 2, 2, 2, 2);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testNegativeLong()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1l, 2l, 2l, 2l, 2l, 2l, 2l, 2l, 2l, 2l);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testNegativeDouble()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveFloat()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1.0f, -1.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveInt()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1, -1, 2, 2, 2, 2, 2, 2, 2, 2);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveLong()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1l, -1l, 2l, 2l, 2l, 2l, 2l, 2l, 2l, 2l);
		}
		ValidationException.resetErrorHandler();
	...
	public boolean testPositiveDouble()
	{
		...
		ValidationException.setErrorHandler(handler);
		{
			Validate.isBelowOOO(1.0d, -1.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d, 2.0d);
		}
		ValidationException.resetErrorHandler();
